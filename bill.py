...
class Bill_App:
	def __init__ (self,root):
		...
		F1=LabelFrame(self.root,bg=bg_color,text="Customer Details",font=("times new roman",15,"bold"),fg="gold")
		...
		cust_text_entry=Entry(F1,width="15",textvariable=self.customer_name, font="arial 15",bd=7,relief=SUNKEN).grid(row=0,column=3,padx=10,pady=5);
		...
		cust_phone_entry=Entry(F1,width="15",textvariable=self.customer_ph,font="arial 15",bd=7,relief=SUNKEN).grid(row=0,column=8,padx=10,pady=5);
		...
		cust_bill_entry=Entry(F1,width="15",textvariable=self.customer_BillNo,font="arial 15 ", bd=7,relief=SUNKEN).grid(row=0,column=12,padx=10,pady=5);


		btn_bill=Button(F1,text="Search",command=self.find_bill,width=10,bd=7).grid(row=0,column=15)
		...
		ColdDrinkP2=Label(F4,text="Mairinda",bg=bg_color,fg="#5cb484",font=("times new roman",12,"bold")).grid(row=1,column=0,padx=30,pady=15)
		ColdDrinkP2_Entry=Entry(F4,width="15",textvariable=self.Mairinda,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=1,column=5,padx=30,pady=15);
		...
		ColdDrinkP5=Label(F4,text="Shezan",bg=bg_color,fg="#5cb484",font=("times new roman",12,"bold")).grid(row=4,column=0,padx=30,pady=15)
		ColdDrinkP5_Entry=Entry(F4,width="15" ,textvariable=self.Shezan,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=4,column=5,padx=30,pady=15);
	...
	#==========================================Bill Area===========================================
		...
		Bil_Label=Label(Bill_f,text="Bill Area",bd=3,relief=GROOVE, font=("Comic Sans MS",14,"bold")).pack(fill=X)
		...
		totalColdDrinksPrice=Label(F5,text="Total Colde Drinks Price",fg="white",font=("times new roman",15,"bold"),bg=bg_color).grid(row=2,column=0,padx=2,pady=0);
		...
		totalCosmeticsTax=Label(F5,text="Cosmetic Tax",fg="white",font=("times new roman",15,"bold"),bg=bg_color).grid(row=0,column=20,padx=2,pady=0);
		...
		totalGroceryTax=Label(F5,text="Grocery Tax",fg="white",font=("times new roman",15,"bold"),bg=bg_color).grid(row=1,column=20,padx=2,pady=0);
		...
		totalColdDeinksTax=Label(F5,text="Cold Drinks Tax",fg="white",font=("times new roman",15,"bold"),bg=bg_color).grid(row=2,column=20,padx=2,pady=0);
		...
		total_btn=Button(btn_F,command=self.total,text="Total",width=10,height=2,bd=5,bg="#5cb484",fg="white",font=("times new roman",15,"bold")).grid(row=0,column=0,pady="10",padx="5")
		generate_Bill_btn=Button(btn_F,command=self.bill_area,text="Generate Bill",width=10,height=2,bd=5,bg="#5cb484",fg="white",font=("times new roman",15,"bold")).grid(row=0,column=3,pady="10",padx="5")
		clear_btn=Button(btn_F,text="Clear",command=self.clear_btn,width=10,height=2,bd=5,bg="#5cb484",fg="white",font=("times new roman",15,"bold")).grid(row=0,column=6,pady="10",padx="5")
		Exit_btn=Button(btn_F,text="Exit",command=self.exit_btn,width=10,height=2,bd=5,bg="#5cb484",fg="white",font=("times new roman",15,"bold")).grid(row=0,column=9,pady="10",padx="5")
	...
	def total(self):
		...
		self.totalColdDrinksPriceCalculated=float(		
											...
											(self.Mairinda.get()*self.MairindaPrice)+
											(self.Sting.get()*self.StingPrice)+
											(self.LemonMalt.get()*self.LemonMaltPrice)+
											(self.Shezan.get()*self.ShezanPrice)
											)
	...
	def welcome_bill(self):
		...
		self.txtarea.insert(END,"\tWelcome to Arsalan Store"); 
	...
	def bill_area(self):
		...
		if self.customer_name.get()=="" or self.customer_ph.get()=="":
			...
			if self.Mairinda.get()>0:
				self.txtarea.insert(END,f"\nMairinda\t\t{self.Mairinda.get()}\t\t{self.MairindaPrice*self.Mairinda.get()}");
			...
			if self.Shezan.get()>0:
				self.txtarea.insert(END,f"\nShezan\t\t{self.Shezan.get()}\t\t{self.ShezanPrice*self.Shezan.get()}");
